...
const HTML_ZINDEX = `<div style="position:relative;">
    <div class="ninja-text">Ninja</div>
    <div class="ninja-image"></div>
</div>
`;

const HTML_STICKY = `<div class="sticky-container">
<h5>Sticky Element: Navbar should stick to the top as you scroll down.</h5>
<nav>
    <span>NAVBAR</span>
    <a>Home</a>
    <a>News</a>
...
<h5>After you scroll back up the navbar should be back in its place.</h5>
...
const POSITIONING_EXERCISES = [
  {
    ...
    correctAnswer: {
      selector: '.pie',
      declarations: ['position:relative', 'left:20px', 'top:-30px']
    }
  },
  {
    id: 'fixed-position',
